		...
		if (item != null)
		{
			if (item instanceof ItemSword || item instanceof ItemAxe || item instanceof ItemHoe || item instanceof ItemArmor || item instanceof ItemBow)
			{
				...
				if (nbt != null && Experience.isEnabled(nbt))
				{
					...
					// rarity
					tooltip.add(rarity.getColor() + TextFormatting.ITALIC + I18n.format("weaponlevels.rarity." + rarity.getName()));
					
					// level
					if (level >= Config.maxLevel)
						tooltip.add(TextFormatting.GRAY + I18n.format("weaponlevels.misc.level") + ": " + I18n.format("weaponlevels.misc.max"));
					else
						tooltip.add(TextFormatting.GRAY + I18n.format("weaponlevels.misc.level") + ": " + level);
					
					// experience
					if (level >= Config.maxLevel)
						tooltip.add(TextFormatting.GRAY + I18n.format("weaponlevels.misc.experience") + ": " + I18n.format("weaponlevels.misc.max"));
					else
						tooltip.add(TextFormatting.GRAY + I18n.format("weaponlevels.misc.experience") + ": " + experience + " / " + maxExperience);
					
					// durability
					if (Config.showDurability)
					{
						tooltip.add(TextFormatting.GRAY + I18n.format("weaponlevels.misc.durability") + ": " + (stack.getMaxDamage() - stack.getItemDamage()) + " / " + stack.getMaxDamage());
					}
					...
					{
						tooltip.add(TextFormatting.GRAY + "" + TextFormatting.ITALIC + I18n.format("weaponlevels.misc.abilities"));
						tooltip.add("");
						...
						tooltip.add(TextFormatting.GRAY + "" + TextFormatting.ITALIC + I18n.format("weaponlevels.misc.abilities.shift"));
